...
# from .serializers import RhSignupSerializer, EmployeSignupSerializer, CandidatSignupSerializer, UserSerialiser
from .permissions import BasePermission
from .serializers import RhSignupSerializer, EmployeSignupSerializer, CandidatSignupSerializer, UserSerializer
from rest_framework.authtoken.views import ObtainAuthToken
...
# from rest_framework.response import Response
# from .serializers import RhSignupSerializer ,EmployeSignupSerializer, UserSerializer
# from rest_framework.authtoken.models import Token

# class RhSignupSerializer(generics.GenericAPIView):
#       serializer_class=RhSignupSerializer
#       def post(self, request, *args, **kwargs):
#          serializer=self.get_serializer(data=request.data)
#          serializer.is_valid(raise_exception=True)
...
# class EmployeSignupSerializer(generics.GenericAPIView):
#       serializer_class=EmployeSignupSerializer
#       def post(self, request, *args, **kwargs):
#          serializer=self.get_serializer(data=request.data)
#          serializer.is_valid(raise_exception=True)
